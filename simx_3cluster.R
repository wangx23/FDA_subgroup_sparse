...
# stopCluster(cl)
# save(result_x_3cluster_ncl100,file = "../result/result_x_3cluster_ncl100.RData")
...
cl <- makeCluster(24)
registerDoParallel(cl)
result_x_3cluster_ncl50lams2 <- foreach(mm=1:150,
                                    .packages=c("flexclust","orthogonalsplinebasis","plyr","cluster"),
                                    .errorhandling = "remove") %dopar%subfunx3cluster(mm)
stopCluster(cl)
save(result_x_3cluster_ncl150lams2,file = "../result/result_x_3cluster_ncl50lams2.RData")
