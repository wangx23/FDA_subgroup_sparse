...
stopCluster(cl)
save(result_x_2cluster05,file = "../result/result_x_2cluster_xvalue05_ncl50.RData")
...
result_x_2cluster05_ydist <- foreach(mm=1:100,
                               ...
                               .errorhandling = "remove") %dopar%subfunx2cluster(mm)
stopCluster(cl) 
save(result_x_2cluster05_ydist,file = "../result/result_x_2cluster_xvalue05_ydist_ncl50.RData")